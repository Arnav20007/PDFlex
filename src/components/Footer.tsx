  ...
  return (
    <footer className="bg-slate-50 border-t border-slate-200/80 pt-16 pb-12">
      <div className="max-w-5xl mx-auto px-4 sm:px-6">
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-8 mb-12">
          ...
          <div className="col-span-2 sm:col-span-1">
            ...
            <p className="text-xs text-slate-500 leading-relaxed max-w-xs">
              Free PDF and image tools for everyday file tasks.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs text-slate-600">
              ...
              <li><a href="/watermark-pdf" className="hover:text-blue-600 transition-colors">Watermark PDF</a></li>
              <li><a href="/add-page-numbers" className="hover:text-blue-600 transition-colors">Add Page Numbers</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs text-slate-600">
              ...
              <li><a href="/jpg-to-png" className="hover:text-blue-600 transition-colors">Image Converter</a></li>
              <li><a href="/jpg-to-png" className="hover:text-blue-600 transition-colors">JPG to PNG</a></li>
              <li><a href="/png-to-jpg" className="hover:text-blue-600 transition-colors">PNG to JPG</a></li>
            </ul>
          </div>
        ...
        <div className="pt-8 border-t border-slate-200/80 text-center sm:text-left text-xs text-slate-500">
          © 2026 PDFlex. All rights reserved.
        </div>
      </div>
    </footer>
  );
